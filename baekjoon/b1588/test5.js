...
P=(n,x,l)=>{//l<=i 위치 항목들 수
  ...
  r=H(n,x);
  if(!l)return r;
  let nn=E(l),xx=F(n-nn,x,0);
}
console.log(P(1,1,0)); //[1,1,1]
console.log(P(1,2,0)); //[2,1,0]
console.log(P(1,3,0)); //[0,2,1]

console.log(P(1,1,1)); //[0,1,1]
console.log(P(1,2,1)); //[2,0,0]
console.log(P(1,3,1)); //[0,1,1]

console.log(P(1,1,2)); //[0,1,0]
console.log(P(1,2,2)); //[1,0,0]
console.log(P(1,3,2)); //[0,1,0]