...
P(3,2,4); // nn=2, u=3, l/u|0=1, xx=2, xxx=1
P(3,2,5); // nn=2, u=3, l/u|0=1, xx=2, xxx=1

P(3,2,6); // nn=2, u=3, l/u|0=2, xx=2, xxx=1
P(3,2,7); // nn=2, u=3, l/u|0=2, xx=2, xxx=1
P(3,2,8); // nn=2, u=3, l/u|0=2, xx=2, xxx=1
