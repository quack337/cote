...
console.log(P(2,1,0)); // [3,4,2]
console.log(P(2,1,1)); // [2,4,2]
console.log(P(2,1,2)); // [2,4,1]
console.log(P(2,1,3)); // [2,3,1]
console.log(P(2,1,4)); // [2,2,1]
console.log(P(2,1,5)); // [2,2,0]
console.log(P(2,1,6)); // [2,1,0]
console.log(P(2,1,7)); // [2,0,0]
console.log(P(2,1,8)); // [1,0,0]