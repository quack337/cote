...
public class Main1 {
    ...
    static void bsearchMax() { // 이진 탐색으로 방문할 최대 높이를 찾는다
        int start = minHeight, end = maxHeight, answer = 0;
        while (start <= end) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int result1 = maxHeight - minHeight;

        minHeight = 1;
        maxHeight = 1000000;
        bsearchMin(); bsearchMax();
        int result2 = maxHeight - minHeight;
